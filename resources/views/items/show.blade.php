...
<div class="container-fluid pt-3">
    <div class="row justify-content-center">
        <div class="col-sm-8">
            <x-compendium-item :item="$item" itemType="item" :is-dm="$isDm" :last-updated="$lastUpdated" :on-map="0" />
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="delete-compendium-item">Delete Item</button>
            </div>
        </div>
    </div>
</div>
...
@section('scripts')
    ...
    <script type="module" src="{{ asset('js/items.js') . '?' . time() }}"></script>
@endsection