...
<div class="container-fluid pt-3">
    <div class="row justify-content-center">
        <div class="col-sm-8">
            <x-compendium-item :item="$place" itemType="place" :is-dm="$isDm" :last-updated="$lastUpdated" :on-map="0" />
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>This will permanently delete the selected place.</p>
                <p>Are you sure you want to delete?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-danger" id="delete-compendium-item">Delete Place</button>
            </div>
        </div>
    </div>
</div>
